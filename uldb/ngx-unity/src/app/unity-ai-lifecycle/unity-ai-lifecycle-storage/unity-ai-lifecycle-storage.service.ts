...
import {
  STORAGE_SUMMARY_KPIS, StorageSummaryKpi,
  STORAGE_POOL_CARDS, StoragePoolCard,
  IO_OPERATION_DATA,
  STORAGE_BY_TENANT_DATA,
  DATA_GROWTH_TREND,
  STORAGE_POOL_INVENTORY, StoragePoolInventoryItem
} from './unity-ai-lifecycle-storage.constants';

@Injectable()
export class UnityAiLifecycleStorageService {
